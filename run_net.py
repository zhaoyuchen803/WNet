...
def train(data_folder=".", model_folder="runs"):
    ...
    net.load_state_dict(torch.load('/home/xiaoguai0992/covid-19-20/checkpoints_unet_500/net_key_metric=0.6119.pt', map_location=device))
    max_epochs, lr, momentum = 100, 1e-6, 0.95
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", metavar="mode", default="infer" , type=str, help="mode of workflow")
    parser.add_argument("--data_folder", default="/home/xiaoguai0992/covid-19-20/test_data", type=str, help="training data folder")
    parser.add_argument("--model_folder", default="/home/xiaoguai0992/covid-19-20/checkpoints_unet_500", type=str, help="model folder")
