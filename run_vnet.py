...
def train(data_folder=".", model_folder="runs"):
    ...
    net = get_vnet().to(device)
    net.load_state_dict(torch.load('/home/xiaoguai0992/covid-19-20/runs/net_key_metric=0.5712.pt', map_location=device))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_folder", default="/home/xiaoguai0992/covid-19-20/runs", type=str, help="model folder")
    args = parser.parse_args()

    monai.config.print_config()
    monai.utils.set_determinism(seed=1)
