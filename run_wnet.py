...
def train(data_folder=".", model_folder="runs"):
    ...
    net.load_state_dict(torch.load('/home/xiaoguai0992/covid-19-20/checkpoints_wnet/net_key_metric=0.6317.pt', map_location=device))
    max_epochs, lr, momentum = 500, 5*1e-5, 0.95
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_folder", default="/home/xiaoguai0992/covid-19-20/checkpoints_wnet", type=str, help="model folder")
